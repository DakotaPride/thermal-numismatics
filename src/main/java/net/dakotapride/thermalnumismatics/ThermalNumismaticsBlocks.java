...
import static cofh.thermal.lib.util.ThermalIDs.ID_MACHINE_FRAME;
import static net.minecraft.world.level.block.state.BlockBehaviour.Properties.of;

public class ThermalNumismaticsBlocks {

    public static DeferredRegisterCoFH<Block> BLOCKS = DeferredRegisterCoFH.create(ForgeRegistries.BLOCKS, ThermalNumismatics.MOD_ID);

    public static RegistryObject<Item> TRADE_STATION = registerAugmentableBlock("trade_station", () -> new EntityBlockActive4Way(of().sound(SoundType.NETHERITE_BLOCK).strength(2.0F).lightLevel(lightValue(ACTIVE, 0)), TradeStationBlockEntity.class, ThermalNumismaticsBlockEntities.TRADE_STATION), () -> ThermalCoreConfig.machineAugments, MACHINE_VALIDATOR, ThermalNumismatics.MOD_ID);
    ...
    public static RegistryObject<Block> register(String name) {
        ...
        ThermalNumismaticsItems.ITEMS.register(name, () -> new BlockItem(block.get(), new Item.Properties()));
        return block;
    }
    ...
    public static RegistryObject<Item> registerItem(String name, Supplier<Item> sup) {
        ...
        return ThermalNumismaticsItems.ITEMS.register(name, sup);
    }
