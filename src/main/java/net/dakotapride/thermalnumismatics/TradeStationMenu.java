...
import static net.dakotapride.thermalnumismatics.ThermalNumismaticsMenuTypes.TRADE_STATION_CONTAINER;


public class TradeStationMenu extends BlockEntityCoFHMenu {

        public final Reconfigurable4WayBlockEntity tile;

        public TradeStationMenu(int windowId, Level level, BlockPos pos, Inventory inventory, Player player) {

            super(TRADE_STATION_CONTAINER.get(), windowId, level, pos, inventory, player);
